...
// Date        : Mon Sep 20 23:38:05 2021
// Host        : boba running 64-bit unknown
// Command     : write_verilog -file
//               /home/vega/github/fpga-prim-examples/ultrascale/behavioral_bram_1024_16/out/main_netlist.v
// Design      : main
...
module main_impl
  ...
  RAMB18E2 #(
    ...
    .WRITE_WIDTH_B(0)) 
    ram_reg_bram_0
       (.ADDRARDADDR({addr,\<const1> ,\<const1> ,\<const1> ,\<const1> }),
